...
\NEW{Sign}{\sBatterySource}{%%3 sources in game, each has 3 batteries, for a total of 9 available in game.
  ...
  \s\MYloc	{200-002}
  \s\MYtext	{This chemical stock room has sulfuric acid in it. You can build a battery here. To do so, take 2 minutes and consume 1 copper(\iCoppr{\MYnumber{}}), and 1 zinc(\iZinc{\MYnumber{}}) (tear them up), then take a battery (\iBattery{\MYnumber{}}).}
...
\NEW{Sign}{\sConduitLocatingNumber}{
  ...
  \s\MYloc	{}
  \s\MYtext	{{\Huge 487}} %%Active numbers: 1461, 1948, 2453, 2922, 3409, 3896, 4383, 5357, 5844, 6331, 6818, 7305, 7792, 8279, 8766, 9253, 9740 (974 and 4870 also have 4870 as a factor, but i am leaving them out because it is too easy to see that they are)
}
...
\NEW{SignSmall}{\sConduitOne}{
  \s\MYname	{A Possible Location of Closest Contact 1.}
  \s\MYloc	{}%%TBD
  ...
  %% Possible Active numbers: 1461, 1948, 2453, 2922, 3409, 3896, 4383, 5357, 5844, 6331, 6818, 7305, 7792, 8279, 8766, 9253, 9740
  \begin{enumerate}
  \item 2:00 - 2:30 PM || 
  \item 2:30 - 3:00 PM ||
  \item 3:00 - 3:30 PM ||
...
\NEW{SignSmall}{\sConduitTwo}{
  \s\MYname	{A Possible Location of Closest Contact 2.}
  \s\MYloc	{}%%TBD
  \s\MYtext	{
  }
  }
