...
\NEW{PC}{\cQueen}{ %%Fire Queen
  ...
  \s\MYgreens	{}
  \s\MYabils	{\aEnslave{} \aModifierSummonFire{}}
...
\NEW{PC}{\cLoyal}{
  ...
  \s\MYblues	{\bElemental{} \bKnowQ{}}
  \s\MYgreens	{}
  \s\MYabils	{\aEnslave{} \aModifierSummonQuintessence{} \aModifierSummonEarth{}}
...
\NEW{PC}{\cKing}{ %%Air King
  ...
  \s\MYabils	{\aEnslave{} \aDrawBlood{} \aModifierSummonAir{}}
...
\NEW{PC}{\cNaturalist}{ 
  ...
  \s\MYblues	{\bElemental{}}
  \s\MYgreens	{\nDampener{}}
  \s\MYabils	{\aEnslave{} \aCollaborate{} \aUnsealConduit{} \aModifierSummonAir{}}
...
\NEW{PC}{\cAvatar}{
  ...
  \s\MYgreens	{ \gTreaty{} }
  \s\MYabils	{\aResistEnslave{} \aModifierSummonQuintessence{}}
  \s\MYitems	{\iQEssence{}}
  \s\MYwhites	{}
