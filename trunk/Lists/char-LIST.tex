...
\NEW{PC}{\cGD}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{190}
   \s\MYdesc     {A tired looking scientist.}
...
\NEW{PC}{\cAvatar}{
  ...
  \s\MYabils	{\aQEnslave{} \aResistEnslave{} \aModifierSummonQuintessence{} \aGlowInDark{} \aAvatarPsychlim{}}
...
\NEW{PC}{\cRomeo}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{707}
   \s\MYdesc     {A burly man in a sharp black suit and an ear piece}  
    
  \s\MYblues	{\bHumanHistory{}}
  \s\MYgreens	{\nBelt{} \gEnslave{}}
  \s\MYabils	{\aResistEnslave{} \aFirstAid{} \aAziLimits{} \aBodyguard{}}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYmems {\mAziRetape{}}
  \s\MYcr	{3}
...
\NEW{NPC}{\cGM}{
  ...
  \s\MYfile{GM.tex}
  \s\MYgreens {\gActiveConduitLocations{} \gStats{} \gEndGame{} }
