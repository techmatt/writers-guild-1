...
\NEW{MemPage}{\mStressMSOne}{
  \s\MYname     { Open when you see badge number \cMSnumber{} }
  \s\MYtext     { You recognize this \cMS{\human}, but you're not sure why. }
  }

\NEW{MemPage}{\mStressMSTwo}{
  \s\MYname     { Open if you talk to badge number \cMSnumber{} for at least three minutes }
...
\NEW{MemPage}{\mStressEarthTwo} {
  \s\MYname     { Open if you interact with badge number \cMinionNumber{} }
...
\NEW{MemPage}{\mStressMSThree} {
  \s\MYname     { Open if you interact with badge number \cMSnumber{} for a total of at least ten minutes  }
...
\NEW{MemFold}{\mGDExperiment}{
  ...
  \s\MYname	{Z Packet}
  \s\MYtext	{Your have a massive migraine from the vast amount of audio-visual stimuli that was just blasted at you. This procedure is painful and interacts in a very confusing fashion with your prior Azi training leaving you in a persistent daze. Your previous connections to your supervisor has been severed, and your new supervisor is now \cMS{\intro}. The re-training forces you to obey \cMS{}'s commands unless they endanger your life or the action is extremely contrary to your character's persona. You can still act independently (including telling others what happened to you) unless \cMS{} orders you not to.}
  }
...
\NEW{MemFold}{\mWhiteTech}{
  ...
  \s\MYtext	{Can humans manufacture this substance, which the Quintessence make? If so, it is critical that you protect this source and keep it out of the hands of the other elementals. A steady supply of this substance is worth signing a treaty over.}
}

%%Triggers if Fire Queen or Avatar see white
\NEW{MemFold}{\mSeeWhite}{
  \s\MYname     {Open if you see item number \iWhiteNumber{}}
  \s\MYtext     {This \iWhite{} looks just like the substance the Quintessence produce, back on the elemental plane.}
}

\NEW{MemFold}{\mLoseEssence}{
  \s\MYname	{Open if you give away or lose an Elemental Essence.}
  \s\MYtext	{That was incredibly painful! You have a -1CR for 10 minutes. Further you are extremely angry at whoever took your essence. \emph{This mempacket triggers again if you lose another essence.}}
}

\NEW{MemFold}{\mAvatarLoseEssence}{
  \s\MYname	{Open if you lose an Elemental Essence.}
  \s\MYtext	{That was very painful. You are extremely angry at whoever took your essence. \emph{This mempacket triggers again if you lose another essence.}}
}
