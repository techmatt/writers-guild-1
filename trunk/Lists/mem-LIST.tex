...
\NEW{MemFold}{\mNaturalistSeesGD}{
  \s\MYname     { Open when you see badge number \cGDnumber{} }
...
\NEW{MemFold}{\mNaturalistSeesAziSci}{
  \s\MYname     { Open when you see badge number \cScientistnumber{} }
