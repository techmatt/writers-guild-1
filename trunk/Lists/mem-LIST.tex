...
\NEW{MemPage}{\mStressMSOne}{
  \s\MYname     { Open when you interact with badge number \cMSnumber{} for at least three minutes}
  \s\MYtext     { You recognize this \cMS{\human}, but you're not sure why. }
  }

\NEW{MemPage}{\mStressMSTwo}{
  \s\MYname     { Open if you interact with badge number \cMSnumber{} a second time, for at least three minutes  }
