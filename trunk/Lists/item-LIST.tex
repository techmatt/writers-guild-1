...
\NEW{ItemFold}{\iWhite}{%%Azi Sci
  ...
  \s\MYnumber	{\iWhiteNumber{}}
  \s\MYtext	{Open if you eat}
  \s\MYcontents	{If you are an elemental: +1CR for 10 min. You feel extremely amiable toward the person who gave you this. You cannot attack or enslave this person for 10 minutes. {\bf If you are wounded, administering Elementium heals you instead. You are just knocked out.}
  If you are human: Yuck, this powder leaves a bad taste in your mouth but there are no other effects.}
  \unstash{}
}
