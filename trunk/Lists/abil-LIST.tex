...
\NEW{Abil}{\aMakeWhite}{
  ...
  \s\MYeffect	{You have figured out how to synthesize \iWhiteQ{}. If you would like to do so, find \sTransmogrifier{}, destroy one \iQEssence{}, and take one \iWhite{} from the \sTransmogrifier{}. This triggers your ``\mAvatarLoseEssence{}' packet. {\bf you may use this ability this 1x every 30 minutes.}}
}
