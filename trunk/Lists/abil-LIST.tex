...
\NEW{Abil}{\aFakeEnslavement}{
  ...
  \s\MYeffect  {When an enslavement targeting you would otherwise fail, you may pretend that it succeeded.  The enslaver will be unable to tell that the enslavement failed as long as you obey them, but you are not bound to follow their commands unless you choose to. (U)}
%Rogue
}

\NEW{Abil}{\aDefySuperiors}{
  \s\MYname  {You would defy your superiors?!}
  \s\MYtext  {I can deliver an impressive speech to shame someone into taking their orders seriously.}
  \s\MYeffect  {By berating them, cause someone with superiors to take their orders seriously and obey them to the letter for 5 minutes. (x3)}
%Loyal
}

\NEW{Abil}{\aFascinatingDirt}{
  \s\MYname  {What a fascinating piece of dirt}
  \s\MYtext  {I can become entranced by my surroundings and oblivious to the people around me.}
  ...
  \s\MYtext  {I can perform a conversational segue so sudden and jarring that others are stunned into following it.}
...
\NEW{Abil}{\aFromHistory}{
  ...
  \s\MYtext  {I can impress humans with the depth of my interest in their history.}
...
\NEW{Abil}{\aMindYourManners}{
  ...
  \s\MYtext  {I can intimidate a small group of humans into fleeing my presence.}
...
\NEW{Abil}{\aWasThatConvincing}{
  ...
  \s\MYtext  {I can oblivious to political intricacies.}
...
\NEW{Abil}{\aBlindingCharm}{
  ...
  \s\MYtext  {I can turn up my natural charm in order to earn someone's trust.}
...
\NEW{Abil}{\aCalmDown}{
  \s\MYname  {Now, everyone calm down...}
  \s\MYtext  {I can use my training as a negotiator to defuse an escalating situation.}
...
\NEW{Abil}{\aLargerPurpose}{
  ...
  \s\MYtext  {I can use my resolve to serve humanity in order to resist manipulation.}
  \s\MYeffect  {If a social ability or command under enslavement would cause you to neglect or act against the greater good of huamnity as you see it, that ability or command does not affect you. (U)}
  %Leader
}

\NEW{Abil}{\aEndsJustify}{
  \s\MYname  {The ends justify the means}
  \s\MYtext  {I can convince someone to see the larger picture and work towards the greater good even if there is some lesser evil involved.}
...
\NEW{Abil}{\aExpertNegotiator}{
  ...
  \s\MYtext  {I can tells with certainty when someone lies to me.}
...
\NEW{Abil}{\aForScience}{
  ...
  \s\MYtext  {I can get others excited about a research question.}
...
\NEW{Abil}{\aMomentOfClarity}{
  ...
  \s\MYtext  {I can impress people with my gravity by dropping my normal insane flair.}
...
\NEW{Abil}{\aStudyHistory}{
  ...
  \s\MYtext  {I can invoke the memory of my great-grandfather's accident in order to discourage irresponsible science.}
...
\NEW{Abil}{\aInsubordination}{
  ...
  \s\MYeffect  {Through extreme determination, you can hold off enslavement for a little while.  When you would be enslaved, you can delay the enslavement by up to 1 minute.  After that minute, you will be enslaved as normal. (x3)}
  %MiniEarth
}

\NEW{Abil}{\aDontMindMe}{
  \s\MYname  {Don't mind me...}
  \s\MYtext  {I can play up my low rank to look very small and inconspicuous, encouraging others to forget I'm even around.}
...
\NEW{Abil}{\aUsefulRunt}{
  ...
  \s\MYtext  {I can gain some surprising insights, seemingly through luck and obliviousness.}
