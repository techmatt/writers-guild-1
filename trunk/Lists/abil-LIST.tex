...
\NEW{Abil}{\aMakeWhite}{
  ...
  \s\MYeffect	{You have figured out how to synthesize \iWhiteQ{}. If you would like to do so, find a quiet location conducive to meditating (the place where the water elementals would have met may work), destroy one \iQEssence{}, and take one \iWhiteQ{} from that location. {\bf You may use this ability this once every 30 minutes.}}
}
