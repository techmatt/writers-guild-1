...
\NEW{Place}{\pAziLab}{
  \s\MYname	{Room -002}%%near human HQ
  \s\MYsigns	{\sBatterySource{} \sSciLab{} \sRaidSci{} \sTransmogrifier{} \sAziSciLabBench{}  \sPeriodicTable{} \sDistilling{}}
  \s\MYitems	{}
  }
...
\NEW{Place}{\pGardens}{
 ...
 \NEW{Place}{\pConduitLocators}{
  \s\MYname	{Conduit}%%Carts
	\s\MYsigns	{\multi{2}{\sConduitLocatingNumber{}}} %%2 copies for 2 carts.
	\s\MYgreens {\multi{2}{\gConduitCover{} \gConduit{} \gConduitModifier{}}}
  \s\MYitems	{}
  \s\MYabils {}
  }
