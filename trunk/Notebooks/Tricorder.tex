...
If you wish to detect the strength of an elemental, spend 30 seconds investigating with the Tricorder. The player must then reveal their %$\beta$ score to you. $\beta$ scores mean:
\begin{enumerate}
