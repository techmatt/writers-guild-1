...
weapon (melee or ranged).  A killing blow requires a 5-count (see
...
{\bf Attacks do not require weapons in this game.} Everyone in game is 
assumed to either have the innate ability to make both \aKnockOut{} and 
\aWound{} attacks or they have in their possession a small knife that 
cannot be taken from them. (A player cannot be disarmed of this knife.
It is not an item, has no item card, and cannot be taken via a search.)
...
Enslavement works in almost the same way as other martial attacks. 
...
The conduit can be opened in one at one of two strengths. During most of game, 
