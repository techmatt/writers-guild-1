...
You returned to your senses some time later, in the middle of a badly smashed-up lab.  The earth elementals seemed to have failed at whatever they were working on.  You met \cGD{\intro}, the scientist who ran the lab, who only returned after seeing that the elementals were gone.  
...
In addition to your other responsibilities, you have authorization to act as a Justice of the Peace for human affairs (e.g., conduct weddings), although you don't expect that to be relevant at this conference.
...
\begin{itemz}[Notes]
\item If you choose to explain your joint condition to someone, once they know that you are both \cAvatar{} and the elemental Vitality, tell them to open their ``\mUnstickAvatar{\MYname}''.  (If they don't have one, then don't worry about it.)
\item If you choose to attack or defend using a CR greater than 2 (plus any technological weapons or defenses), you are using Vitality's abilities in addition to \cAvatar{}'s.  In this case, your \aGlowInDark{} ability is automatically activated, and your attack is suitably glowy.  You should make sure this is clear to any players who can see you.
\end{itemz}
