...
\updatemacro{\cActive}{
  \rs\MYplayer          {Winfield Brown}
}

\updatemacro{\cBride}{
  \rs\MYplayer          {Mahayah Phillips}
}

\updatemacro{\cGroomA}{
  \rs\MYplayer          {Reed Nightingale}
}

\updatemacro{\cGroomB}{
  \rs\MYplayer          {Alexander Harris}
}

\updatemacro{\cKid}{
  \rs\MYplayer          {Meghana Manickam}
}

\updatemacro{\cPassive}{
  \rs\MYplayer          {Yvonne Kung}
}

\updatemacro{\cPastor}{
  \rs\MYplayer          {Cameron Matthias Campbell}
}

\updatemacro{\cProgrammer}{
  \rs\MYplayer          {Paul Kivelson}
}

\updatemacro{\cRival}{
  \rs\MYplayer          {Aaron Silverman}
}

\updatemacro{\cScientist}{
  \rs\MYplayer          {Like Gobeawan}
}
