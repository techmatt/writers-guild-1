...
\NEW{Sign}{\sGDLabChair}{
  \s\MYname	{A Metal Chair}
  \s\MYloc	{}%%TBD
  \s\MYtext	{This chair has numerous wires running from it to near-by monitors. There also wrist and ankle cuffs for securing the test subject. 
...
\NEW{Sign}{\sJanitorCloset}{
  ...
  \s\MYitems  {\iWireTightener{} \multi{3}{\iLye{}}}
}
...
\NEW{Sign}{\sPileOfShiny}{
  ...
  \s\MYitems {{\multi{10}{\iZinc{}}} \iTungsten{}}
}
