...
\NEW{Sign}{\sMalachite}{
  ...
  \s\MYloc	{-004}
  \s\MYtext	{There is a vein of malachite in the rock here. Malachite is a naturally occurring form of copper. If you would like to take a piece of malachite, place 1 hand on this sign for 30 seconds.}
...
\NEW{Sign}{\sPileOfShiny}{
  ...
  \s\MYitems {{\multi{10}{\iZinc{}}}}
}

%%Lab Ruins
\NEW{Sign}{\sPileofTools}{
  \s\MYname	{There is a pile of discarded tools here}
