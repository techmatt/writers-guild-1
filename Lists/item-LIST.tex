...
\NEW{ItemFold}{\iWhite}{%%Azi Sci
  ...
  \s\MYtext	{open if you eat}
  \s\MYcontents	{If you are a human, this substance looks and tastes like baking soda. Bleh. If you are an elemental, you should have received a packet from whoever gave this to you. If not, go see a GM.}
  \unstash{}
}
...
\NEW{Item}{\iWhitePowder}{%%HOW IS THIS DIFFERENT THAN THE "WHITE" ITEM ABOVE?
  ...
  \s\MYnumber   {\iWhiteNumber{}}
  \s\MYtext     {You do not know what this substance is but it looks interesting.}
  \unstash{}
}
...
\NEW{Item}{\iFireEssence}{%%Fire Eles
  ...
  \s\MYnumber	{}
  \s\MYtext	{--BOUND-- This is a piece of fire elemental essence. It is not in-game transferable  unless the owner choose to give it away, it is taken via a specific mechanic, or the owner dies - in which case the essence drops and becomes in-game transferable.}
}
...
%%GD fetch items
\NEW{Item}{\iWireTightener}{%%JanitorCloset | Gardens
