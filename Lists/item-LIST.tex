...
\NEW{Item}{\iFireEssence}{%%Fire Eles
  ...
  \s\MYnumber	{}
  \s\MYtext	{This is a piece of fire elemental essence. It is not in-game transferable  unless the owner choose to give it away, it is taken via a specific mechanic, or the owner dies - in which case the essence drops and becomes in-game transferable.}
}
