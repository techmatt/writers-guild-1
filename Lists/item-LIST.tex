...
\NEW{ItemFold}{\iCopper}{%%Malachite
  ...
  \s\MYcontents	{This item is now a strip of copper. Copper makes a good cathode for batteries.}
}
...
\NEW{Item}{\iHeisenbergCompensator}{%%Heisenberg Compensator for Elemental Barrier Belt
...
\NEW{Item}{\iCrystalGeode}{%%Crystal geode for Elemental Barrier Belt
  \s\MYname	{Crystal Geode}
  \s\MYnumber	{}
  \s\MYtext	{A heavy, hemispherical piece of rock.  At first you think it looks like an ugly, grey, and pitted.  Then you turn it over and see its polished interior, deep blue with brilliant crystals.}
  \bulky{1}
}

\NEW{Item}{\iLavaEmber}{%%Lava ember for Elemental Barrier Belt
  \s\MYname	{Lava Ember}
  \s\MYnumber	{}
...
\NEW{Item}{\iHolographicLaser}{%%A fancy holographic laser
...
\NEW{Item}{\iAziTape}{%%Incomplete tape for Azi reeducation
...
\NEW{Item}{\iAirplanePiece}{%%A fragment of the downed airplane
