...
\NEW{PC}{\cQueen}{ %%Fire Queen
  ...
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aFireEnslave{} \aModifierSummonFire{} \aFireWall{} \aHeatThings{} \aBecomeFiery{} \aMindYourManners{}}
...
\NEW{PC}{\cPyro}{ %%Fire second
  ...
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aFireEnslave{} \aModifierSummonFire{} \aHeatThings{} \aBecomeFiery{} \aWasThatConvincing{}}
...
\NEW{PC}{\cJuliet}{
  ...
  \s\MYblues	{\bElemental{}}
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aFireEnslave{} \aModifierSummonFire{} \aHeatThings{} \aBecomeFiery{} \aBlindingCharm{}}
