...
\NEW{PC}{\cAvatar}{
  ...
  \s\MYitems	{\iQEssence{}}
  \s\MYwhites	{}
  \s\MYmems {\mAvatarLoseEssence{} \mSeeWhite{} \mAvatarHearsBell{}}
  \s\MYcr	{5}
 }
...
\NEW{NPC}{\cGM}{
  ...
  \s\MYfile{GM.tex}
  \s\MYabils	{\aModifierChannelWhite{} \aDominate{} \aAziEnslave{} \aAziEnslave{} \aAziEnslave{} \aQEnslave{} \aFireEnslave{} \aEarthEnslave{} \aAirEnslave{}}
  \s\MYcr	{77777}
}
