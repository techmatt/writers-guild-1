...
\NEW{PC}{\cQueen}{ %%Fire Queen
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{240}
   \s\MYdesc     {A tall figure composed entirely of flames}
 
  \s\MYblues	{\bElemental{} \bKnowQ{}}
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aFireEnslave{} \aModifierSummonFire{} \aFireWall{} \aHeatThings{} \aBecomeFiery{} \aPhysicalContact{}}
...
\NEW{PC}{\cPyro}{ %%Fire second
  ...
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aFireEnslave{} \aModifierSummonFire{} \aHeatThings{} \aBecomeFiery{} \aPhysicalContact{}}
...
\NEW{PC}{\cLoyal}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{587} 
   \s\MYdesc     {An imposing limestone stone statue that moves}
   
  \s\MYblues	{\bElemental{} \bKnowQ{}}
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aEarthEnslave{} \aModifierSummonQuintessence{} \aModifierSummonEarth{} \aEarthTrap{} \aEarthSpeaker{}}
...
\NEW{PC}{\cRogue}{
  ...
  \s\MYblues	{\bElemental{} \bKnowQ{}}
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aEarthEnslave{} \aModifierSummonQuintessence{} \aModifierSummonEarth{} \aEarthSpeaker{}}
...
\NEW{PC}{\cKing}{ %%Air King
  ...
  \s\MYabils	{\aAirEnslave{} \aDrawBlood{} \aModifierSummonAir{} \aAirTeleport{}}
...
\NEW{PC}{\cAvatar}{
  ...
  \s\MYabils	{\aQEnslave{} \aResistEnslave{} \aModifierSummonQuintessence{} \aGlowInDark{}}
...
\NEW{PC}{\cRomeo}{
  ...
  \s\MYblues	{\bHumanHistory{}}
  \s\MYgreens	{\nBelt{} \gEnslave{}}
  \s\MYabils	{\aResistEnslave{} \aFirstAid{} \aAziLimits{}}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYmems {\mAziRetape{}}
  \s\MYcr	{3}
...
\NEW{PC}{\cScientist}{
  ...
  \s\MYabils	{\aWorkConduit{} \aResistEnslave{} \aFirstAid{} \aAziLimits{}}
...
\NEW{PC}{\cDiplomat}{
  ...
  \s\MYblues	{\bHumanHistory{}}
  \s\MYgreens	{ \gTreaty{} \gEnslave{}}
  \s\MYabils	{\aResistEnslave{} \aAziLimits{}}
  \s\MYitems	{}
  \s\MYwhites	{}
...
\NEW{PC}{\cMiniWater}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{}
   \s\MYdesc     {A very young water elemental}
   
  \s\MYblues	{\bElemental{}}
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aModifierSummonWater{} \aWaterSneaky{} \aPickLocks{} \aUnsealConduit{}}
  \s\MYitems	{\iWaterEssence{} \iPuddle{}}
  \s\MYmems {\mLoseEssence{}}
  \s\MYcr	{3}
  \s\MYbeta	{1}
  \s\MYgamma	{2}
...
\NEW{PC}{\cMiniEarth}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{}
   \s\MYdesc     {A very young earth elemental}
   
  \s\MYblues	{\bElemental{}}
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aModifierSummonEarth{} \aEarthSpeaker{}}
...
\NEW{PC}{\cMiniAir}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{298}
   \s\MYdesc     {A very young air elemental}
   
  \s\MYblues	{\bElemental{}}
  \s\MYgreens	{\gEnslave{}}
  \s\MYabils	{\aModifierSummonAir{} \aModifierSummonWater{} \aLearnSong{}}
...
\NEW{NPC}{\cGM}{
  ...
  \s\MYfile{GM.tex}
  \s\MYgreens {\gActiveConduitLocations{} \gStats{}}
  \s\MYabils	{\aModifierChannelWhite{} \aDominate{} \aAziEnslave{} \aAziEnslave{} \aAziEnslave{} \aQEnslave{} \aFireEnslave{} \aEarthEnslave{} \aAirEnslave{} \aModifierSummonQuintessence{} \aModifierSummonFire{} \aModifierSummonEarth{}}
